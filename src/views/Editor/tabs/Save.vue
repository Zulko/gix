...
.share
  ...
  p
    el-tooltip(
      content='Save the project in your browser so you can continue it later',
      placement='right'
    )
      el-button(size='mini', @click='downloadProjectJson') Save project locally
  p
    el-tooltip(
      content='Download your project as a JSON file',
      placement='right'
    )
      el-button(size='mini', @click='downloadProjectJson') Download Project
  p
    el-tooltip(
      content='Create a direct link to share your project on the web',
      placement='right'
    )
